...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    icons: {
      'altnext': 'far fa-chevron-right',
      'altprev': 'far fa-chevron-left',
      'next': 'far fa-chevron-right',
      'prev': 'far fa-chevron-left',
      'end': 'far fa-chevron-double-right',
      'start': 'far fa-chevron-double-left',
      'share': 'fas fa-share-alt',
      'help': 'ti-help-alt',
      'more': 'ti-more-alt',
      'download': 'far fa-file-download',
      'zoomin': 'far fa-search-plus',
      'zoomout': 'far fa-search-minus',
      'fullscreen': 'far fa-expand-arrows-alt',
    ...
    text: {
      ...
      toggleSound: "Ton aktivieren/deaktivieren",
      toggleThumbnails: "Übersicht anzeigen/verbergen",
      toggleOutline: "Inhaltsverzeichnis anzeigen/verbergen",
      previousPage: "Vorherige Seite",
      nextPage: "Nächste Seite",
      toggleFullscreen: "Fullscreen anzeigen/verbergen",
      zoomIn: "Vergrößern",
      zoomOut: "Verkleinern",
      toggleHelp: "Hilfe anzeigen/verbergen",
    ...
    allControls: 'altPrev,pageNumber,altNext,outline,thumbnail,zoomIn,zoomOut,fullScreen,download,share',
    moreControls: "",
    hideControls: "",
  ...
  var ContentProvider = (function (_super) {
    ...
    ContentProvider.prototype.initThumbs = function () {
      ...
      var sideMenuClose = $(html.div, {
        class: "df-ui-btn df-ui-sidemenu-close far fa-times"
      });
